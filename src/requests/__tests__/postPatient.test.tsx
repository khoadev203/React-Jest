...
describe('request postPatient', () => {
  it('request should get valid params', async () => {
    ...
    const realm = 'ox'
    const errorMessage = 'either token, patientInfo or realm is missing.'
    const error = postPatient(patientInfo, token, realm)
  ...
  it('request should succeed', async () => {
    ...
    const postResponse = await postPatient(patientInfo, token, realm)
